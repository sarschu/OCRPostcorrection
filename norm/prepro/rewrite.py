    ...
    def tokenize(self,t,norm):#post tokenize '?
        ...
        **parameters**, **types**,**return**,**return types**::
        ...
        if norm.language == "nl":
            ...
            out = proc.communicate()[0]    
        elif norm.language == "de":
            proc = subprocess.Popen(["perl",util.STATIC_DIR+"/tokenizer/utf8-tokenize.perl", "-a",util.STATIC_DIR+"/tokenizer/german-abbreviations-utf8"],stdin=echo.stdout,stdout=subprocess.PIPE,shell=False)
            out = proc.communicate()[0]
        elif  norm.language == "fr":
            proc = subprocess.Popen(["perl",util.STATIC_DIR+"/tokenizer/utf8-tokenize.perl", "-a",util.STATIC_DIR+"/tokenizer/french-abbreviations-utf8"],stdin=echo.stdout,stdout=subprocess.PIPE,shell=False)
            out = proc.communicate()[0]
